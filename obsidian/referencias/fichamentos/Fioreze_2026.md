---
nome_local: Fioreze_2026
openalex_id: exemplos:e9b4988e85f71af47b84
doi: 
ano: None
status: triagem_pendente
acesso_aberto: false
pdf_local: obsidian/referencias/pdfs/dissertacao_wesleyFioreze_23_06_2026_anotada.pdf
...
[PDF local](../pdfs/dissertacao_wesleyFioreze_23_06_2026_anotada.pdf)
...
**Com  — Fioreze_2026: Investigar a integração de identidades auto‑soberanas (SSI/DIDs) com políticas de controle**
...
**Com  — Fioreze_2026: Integrar identidade autossoberana (SSI) e DIDs para dispositivos e cidadãos, usando wallet**
...
**Com  — Fioreze_2026: Implementar registro de revogação baseado em blockchain que suporte revogação seletiva bas**
...
**Com  — Fioreze_2026: Explorar criptografia homomórfica para processamento de dados IIoT sem descriptografia, pr**
...
**Com  — Fioreze_2026: Integrar SSI/DIDs com criptografia baseada em atributos (ABE/CP‑ABE/KP‑ABE) para controle **
...
**Com  — Fioreze_2026: Desenvolver e avaliar listas de revogação distribuídas (CRL) ou esquemas de revogação base**
...
**Com  — Fioreze_2026: Implementar módulos de recuperação de credenciais baseados em secret sharing integrados a **
...
**Com [Gudipati_2025](Gudipati_2025.md) — Framework híbrido VC‑ABE para controle de acesso cidadão em IoT urbano**
...
**Com [S_2026](S_2026.md) — Identidade SSI com ABE para privacidade de turistas em cidades inteligentes**
...
**Com [Gudipati_2025](Gudipati_2025.md) — Registro descentralizado de revogação para credenciais SSI em serviços públicos**

...
doi: 
ano: None
status: preleitura_ler_integralmente
acesso_aberto: false
pdf_local: obsidian/referencias/pdfs/André Luiz Almeida Cardoso.pdf
...
Pré-leitura: ler_integralmente — PDF marcado como trabalho-base em obsidian/ANOTACOES.md usado como semente da pesquisa; leitura integral obrigatória para gerar nota limpa e alimentar o brainstorm de propostas.

[PDF local](../pdfs/Andr%C3%A9%20Luiz%20Almeida%20Cardoso.pdf)
...
**Com  — Cardoso_2024: Integrar identidades autossoberanas (SSI) e credenciais verificáveis ao modelo baseado em **
...
**Com  — Cardoso_2024: Aplicar criptografia baseada em atributos (ABE) para controle de acesso seletivo e divulga**
...
**Com  — Cardoso_2024: Desenvolver mecanismos de revogação distribuída (registradores on‑chain) e protocolos de r**

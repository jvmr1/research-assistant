---
nome_local: Cardoso_2024
openalex_id: exemplos:5a7887da0607cec498ad
doi: 
ano: None
status: leitura_concluida
acesso_aberto: false
...
**Com  — Cardoso (2024): Integrar identidades autossoberanas (SSI) e credenciais verificáveis ao modelo baseado em **
...
**Com  — Cardoso (2024): Aplicar criptografia baseada em atributos (ABE) para controle de acesso seletivo e divulga**
...
**Com  — Cardoso (2024): Desenvolver mecanismos de revogação distribuída (registradores on‑chain) e protocolos de r**
...
**Com [[Hudda_2025|Hudda_2025]] — SSI com ABE para controle de acesso seletivo em sensores IoT de cidades inteligentes**
...
**Com [[Mansoor_2025|Mansoor_2025]] — Credenciais verificáveis com revogação baseada em blockchain para compartilhamento de dados agrícolas em cidades inteligentes**
...
**Com [[Hudda_2025|Hudda_2025]] — Esquema híbrido de revogação e recuperação de acesso usando blockchain e criptografia homomórfica em serviços urbanos IoT**

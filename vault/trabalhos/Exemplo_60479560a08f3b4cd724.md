...
---
# Exemplo_60479560a08f3b4cd724

## Tags

#abe #criptografia #criptografia-homomorfica #privacidade #ssi

dissertacao_wesleyFioreze_23_06_2026_anotada
...
**Com  — Exemplo_60479560a08f3b4cd724: Investigar a integração de identidades auto‑soberanas (SSI/DIDs) com políticas de controle**
...
**Com  — Exemplo_60479560a08f3b4cd724: Integrar identidade autossoberana (SSI) e DIDs para dispositivos e cidadãos, usando wallet**
...
**Com  — Exemplo_60479560a08f3b4cd724: Implementar registro de revogação baseado em blockchain que suporte revogação seletiva bas**
...
**Com  — Exemplo_60479560a08f3b4cd724: Explorar criptografia homomórfica para processamento de dados IIoT sem descriptografia, pr**
...
**Com  — Exemplo_60479560a08f3b4cd724: Integrar SSI/DIDs com criptografia baseada em atributos (ABE/CP‑ABE/KP‑ABE) para controle **
...
**Com  — Exemplo_60479560a08f3b4cd724: Desenvolver e avaliar listas de revogação distribuídas (CRL) ou esquemas de revogação base**
...
**Com  — Exemplo_60479560a08f3b4cd724: Implementar módulos de recuperação de credenciais baseados em secret sharing integrados a **

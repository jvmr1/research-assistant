...
ano: 2025
status: preleitura_manter_como_contexto
acesso_aberto: true
pdf_local: pdfs/Addula_2025.pdf
...
Pré-leitura: manter_como_contexto — O artigo apresenta contribuição relevante sobre blockchain permissionada, criptografia homomórfica e autenticação de dispositivos IoT, oferecendo insights técnicos que podem ser adaptados ao contexto de identidade autossoberana (SSI) em cidades inteligentes. Contudo, o foco está exclusivamente na identidade de dispositivos e não aborda credenciais verificáveis de cidadãos, ciclos de vida de credenciais humanas, ou mecanismos de controle de acesso baseados em atributos (ABE). Como a revisão focada requer evidências diretas sobre SSI, verifiable credentials e as fases de emissão, apresentação, verificação, transmissão, processamento, armazenamento, revogação e recuperação de credenciais de cidadãos, este trabalho não pode sustentar nenhuma das seções centrais da revisão. Ele pode ser mantido como referência de apoio para a camada de infraestrutura blockchain e técnicas criptográficas, mas não justifica leitura integral nem pode ser usado como fonte primária para mapear o ciclo de vida das credenciais humanas.
